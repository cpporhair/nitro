...
| Phase 2: Tree-Local Flush | tree_sched + tree_lookup_scheds + tree_worker_scheds + nvme_scheds | `tree_flush_request { base_guard, sealed_gens[], recovery_safe_lsn }` | `tree_flush_result` |
